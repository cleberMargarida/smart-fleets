...
namespace Ingestion.Api.IntegrationTests.Consumers;

public class MessagesConsumerTests :
    IClassFixture<IngestionApplicationFactory>,
    IClassFixture<StubConsumer>
{
    private readonly IngestionApplicationFactory _api;
    private readonly StubConsumer _consumer;

    public MessagesConsumerTests(IngestionApplicationFactory apiFactory, StubConsumer consumer)
    {
        _api = apiFactory;
        _consumer = consumer;
    }
